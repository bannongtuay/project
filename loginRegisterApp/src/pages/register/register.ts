...
const data = new HttpParams().set('case','register').set('username',this.username.value).set('password',this.password.value).set('mobile',this.mobile.value).set('email',this.email.value);
